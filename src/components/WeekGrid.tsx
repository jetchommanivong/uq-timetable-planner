...
export function WeekGrid({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white">
      {/* Day headers stay put while the times scroll. */}
      <div className="flex border-b border-slate-200 bg-slate-50/80 pr-[10px]">
      ...
      <div className="thin-scroll flex-1 overflow-y-auto">
        <div className="relative flex" style={{ height }}>
          ...
          {DAYS.map((day, i) => {
            ...
            return (
              <div key={day} className="relative flex-1 border-l border-slate-200">
                {hours.map((m) => (
                  <div
                    key={m}
